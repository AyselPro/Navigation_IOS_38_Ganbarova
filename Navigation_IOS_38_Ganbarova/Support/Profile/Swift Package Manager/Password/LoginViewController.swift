...
//
//  Created by Aysel on 19.11.2023.
//
...
class LoginViewController: UIViewController {
    ...
    init(delegate: LoginViewControllerDelegate? = nil, passwordUser: String) {
    ...
    private var passwordUser = tryToHackThePassword()
    ...
    // Brute Force Button
    private lazy var passwordHackingButton: UIButton = {
        let button = UIButton()
        button.setTitleColor(.white, for: .normal)
    ...
    private func tryToHackThePassword() {
        ...
        globalQueue.async {
            ...
            self.passwordUser.bruteForced { result in
                switch result {
    ...
    private func checkMyPass(_ infoToCheck: String, time: Date) -> Bool {
            ...
            let cryptedInfo = infoToCheck.aysel30()
